...
public class JRecord extends JCompType {
    ...
    public String getCsharpNameSpace() {
        ...
        return namespace.toString().replace("Org.Apache.Zookeeper", "ApacheZooKeeper");
    }
    ...
    public void genCsharpCode(File outputDirectory) throws IOException {
        ...
        try (FileWriter cs = new FileWriter(new File(pkgdir, getName() + ".cs"));) {
            cs.write("// <auto-generated />\n");
            ...
            cs.write("using ApacheZooKeeper.Jute;\n");
            cs.write("\n");
    ...
    public static String getCsharpFQName(String name) {
        ...
        return fQName.toString().replace("Org.Apache.Zookeeper", "ApacheZooKeeper");
    }
